        ...
        <div id="slider1" class="rev_slider">
          ...
          <ul> 
            <li data-transition="zoomout" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-fstransition="fade" data-fsmasterspeed="1500">
              ...
              <!-- MAIN IMAGE -->
              <!-- <img src="<?php //echo base_url(); ?>assets/images/bg1_1920x965.jpg"  alt=""> -->
              ...
              <div class="tp-caption text1 align_center fadeout"
                ...
                <a href="<?php echo base_url('welcome/register'); ?>" class="mad_button">Register Now</a>
              </div>
            ...
            <li data-transition="zoomout" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-fstransition="fade" data-fsmasterspeed="1500">
              ...
              <!-- MAIN IMAGE -->
              <!-- <img src="<?php //echo base_url(); ?>assets/images/bg2_1920x965.jpg"  alt=""> -->
			  <img src="<?php echo base_url(); ?>assets/images/slide2.jpg"  alt="">
              <div class="tp-caption text1 align_left fadeout"
                data-transform_in="y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;s:2000;e:Power4.easeInOut;" 
                data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;" 
                data-start="500" 
                data-x="left"
                ...
                <a href="<?php echo base_url('welcome/services'); ?>" class="mad_button">Read More</a>
              </div>
            ...
            <li data-transition="zoomout" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-fstransition="fade" data-fsmasterspeed="1500">
              ...
              <!-- MAIN IMAGE -->
              <!-- <img src="<?php //echo base_url(); ?>assets/images/bg3_1920x965.jpg"  alt=""> -->
              ...
              <div class="tp-caption text1 align_center fadeout"
                ...
                data-y="top">
                <h5>- Massages -</h5>
                <h2>Magic Touch of <br> Skilful Masseurs Hands</h2>
    ...
    <div id="content">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <figure class="section_image align_right">
                  <!-- <img src="<?php //echo base_url(); ?>assets/images/women_457x524.png" alt=""> -->
				  <img src="<?php echo base_url(); ?>assets/images/main1.jpg"  alt="">
                </figure>
          ...
          <div class="mad_full_width_grid">
            ...
            <div class="row pattern_section">
              <div id="mad_item_second" class="col-md-6">
                ...
                <div class="mad_pattern bg_pattern_red clearfix">
                  <article class="f_right">
                    ...
                    <a href="<?php echo base_url('welcome/services'); ?>" class="mad_button style2">View all Services</a>
                  </article>
                </div>
              ...
              <div id="mad_item_first" class="col-md-6">
                ...
                <figure class="mad_img_wrap">
                  <!-- <img src="<?php //echo base_url(); ?>assets/images/img_women1.jpg" alt=""> --> 
            ...
            <div class="row pattern_section">
              <div class="col-md-6">
                ...
                <figure>
                <!--  <img src="<?php //echo base_url(); ?>assets/images/img_women2.jpg" alt=""> -->
				  <img src="<?php echo base_url(); ?>assets/images/main12345.jpg"  alt="">
                </figure>
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <figure class="section_image align_right">
                  <!-- <img src="<?php //echo base_url(); ?>assets/images/565x520_img.jpg" alt=""> -->
				  <img src="<?php echo base_url(); ?>assets/images/landing.jpg"  alt="">
                </figure>
                  ...
                  <div class="owl-carousel" data-max-items="3">
                    ...
                    <div>
                      ...
                      <div class="mad_item_hover">
                        <figure>
                          <!-- <img src="<?php //echo base_url(); ?>assets/images/370x370_img1.jpg" alt=""> -->
                    ...
                    <div>
                      ...
                      <div class="mad_item_hover">
                        <figure>
                          <!-- <img src="<?php echo base_url(); ?>assets/images/370x370_img2.jpg" alt=""> -->
                    ...
                    <div>
                      ...
                      <div class="mad_item_hover">
                        <figure>
                          <!-- <img src="<?php echo base_url(); ?>assets/images/370x370_img3.jpg" alt=""> -->
                    ...
                    <div>
                      ...
                      <div class="mad_item_hover">
                        <figure>
                        <!--  <img src="<?php echo base_url(); ?>assets/images/370x370_img4.jpg" alt=""> -->
                    ...
                    <div>
                      ...
                      <div class="mad_item_hover">
                        <figure>
                          <!-- <img src="<?php echo base_url(); ?>assets/images/370x370_img5.jpg" alt=""> -->
                    ...
                    <div>
                      ...
                      <div class="mad_item_hover">
                        <figure>
                          <!-- <img src="<?php echo base_url(); ?>assets/images/370x370_img6.jpg" alt=""> -->
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <figure class="section_image align_center">
                  <!-- <img src="<?php echo base_url(); ?>assets/images/500x385_img.jpg" alt=""> -->
				  <img src="<?php echo base_url(); ?>assets/images/planprice.jpg" alt="">
                </figure>
          ...
          <div class="carousel_type_2 full_width_gallery">
            ...
            <div class="owl-carousel gallery_carousel" data-max-items="4">
              ...
              <div>
                ...
                <div class="mad_item_hover">
                  <figure>
                    <!-- <img src="<?php echo base_url(); ?>assets/images/480x370_img1.jpg" alt=""> -->
					<img src="<?php echo base_url(); ?>assets/images/work1.jpg" alt="">
                  </figure>
                  <div class="item_overlay">
                    <div class="text_holder">
                      <!-- <a href="<?php //echo base_url(); ?>assets/images/480x370_img1.jpg" class="mad_icon_plus gallery" rel="category"></a> -->
					  <a href="<?php echo base_url(); ?>assets/images/work1.jpg" class="mad_icon_plus gallery" rel="category"></a>
                ...
                <div class="mad_item_hover">
                  <figure>
                    <!-- <img src="<?php //echo base_url(); ?>assets/images/480x370_img5.jpg" alt=""> -->
					<img src="<?php echo base_url(); ?>assets/images/work2.jpg" alt="">
                  </figure>
                  <div class="item_overlay">
                    <div class="text_holder">
                      <!-- <a href="<?php //echo base_url(); ?>assets/images/480x370_img5.jpg" class="mad_icon_plus gallery" rel="category"></a> -->
					  <a href="<?php echo base_url(); ?>assets/images/work2.jpg" class="mad_icon_plus gallery" rel="category"></a>
                      <a href="#" class="mad_icon_link"></a>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div class="mad_item_hover">
                  <figure>
                   <!-- <img src="<?php //echo base_url(); ?>assets/images/480x370_img2.jpg" alt=""> -->
					<img src="<?php echo base_url(); ?>assets/images/work3.jpg" alt="">
                  </figure>
                  <div class="item_overlay">
                    <div class="text_holder">
                      <!-- <a href="<?php //echo base_url(); ?>assets/images/480x370_img2.jpg" class="mad_icon_plus gallery" rel="category"></a> -->
					  <a href="<?php echo base_url(); ?>assets/images/work3.jpg" class="mad_icon_plus gallery" rel="category"></a>
                      <a href="#" class="mad_icon_link"></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="mad_item_hover">
                  <figure>
                   <!-- <img src="<?php //echo base_url(); ?>assets/images/480x370_img6.jpg" alt=""> -->
					<img src="<?php echo base_url(); ?>assets/images/work4.jpg" alt="">
                  </figure>
                  <div class="item_overlay">
                    <div class="text_holder">
                      <!-- <a href="<?php //echo base_url(); ?>assets/images/480x370_img6.jpg" class="mad_icon_plus gallery" rel="category"></a> -->
					  <a href="<?php echo base_url(); ?>assets/images/work4.jpg" class="mad_icon_plus gallery" rel="category"></a>
                      <a href="#" class="mad_icon_link"></a>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div class="mad_item_hover">
                  <figure>
                    <!-- <img src="<?php //echo base_url(); ?>assets/images/480x370_img3.jpg" alt=""> -->
					<img src="<?php echo base_url(); ?>assets/images/work5.jpg" alt="">
                  </figure>
                  <div class="item_overlay">
                    <div class="text_holder">
                     <!--  <a href="<?php //echo base_url(); ?>assets/images/480x370_img3.jpg" class="mad_icon_plus gallery" rel="category"></a> -->
					  <a href="<?php echo base_url(); ?>assets/images/work5.jpg" class="mad_icon_plus gallery" rel="category"></a>
                      <a href="#" class="mad_icon_link"></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="mad_item_hover">
                  <figure>
                   <!--  <img src="<?php //echo base_url(); ?>assets/images/480x370_img7.jpg" alt=""> -->
					<img src="<?php echo base_url(); ?>assets/images/work6.jpg" alt="">
                  </figure>
                  <div class="item_overlay">
                    <div class="text_holder">
                      <!-- <a href="<?php //echo base_url(); ?>assets/images/480x370_img7.jpg" class="mad_icon_plus gallery" rel="category"></a> -->
					  <a href="<?php echo base_url(); ?>assets/images/work6.jpg" class="mad_icon_plus gallery" rel="category"></a>
                      <a href="#" class="mad_icon_link"></a>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div class="mad_item_hover">
                  <figure>
                    <!-- <img src="<?php //echo base_url(); ?>assets/images/480x370_img4.jpg" alt=""> -->
					<img src="<?php echo base_url(); ?>assets/images/work7.jpg" alt="">
                  </figure>
                  <div class="item_overlay">
                    <div class="text_holder">
                      <!-- <a href="<?php //echo base_url(); ?>assets/images/480x370_img4.jpg" class="mad_icon_plus gallery" rel="category"></a> -->
					  <a href="<?php echo base_url(); ?>assets/images/work7.jpg" class="mad_icon_plus gallery" rel="category"></a>
                      <a href="#" class="mad_icon_link"></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="mad_item_hover">
                  <figure>
                    <!-- <img src="<?php //echo base_url(); ?>assets/images/480x370_img8.jpg" alt=""> -->
					<img src="<?php echo base_url(); ?>assets/images/work8.jpg" alt="">
                  </figure>
                  <div class="item_overlay">
                    <div class="text_holder">
                      <!-- <a href="<?php //echo base_url(); ?>assets/images/480x370_img8.jpg" class="mad_icon_plus gallery" rel="category"></a> -->
					  <a href="<?php echo base_url(); ?>assets/images/work8.jpg" class="mad_icon_plus gallery" rel="category"></a>
                      <a href="#" class="mad_icon_link"></a>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="owl-carousel" data-max-items="3" data-autoplay="true">
                    ...
                    <div>
                      ...
                      <a href="#" class="mad_item_hover style2">
                        ...
                        <figure>
						  ...
						  <img src="<?php echo base_url(); ?>assets/images/women_model3copy.jpg" alt="">
                        </figure>
                        <div class="mad_item_desc with_bg_img">
                          <div class="mad_author style2">
                    ...
                    <div>
                      ...
                      <a href="#" class="mad_item_hover style2">
                        ...
                        <figure>
                          <!-- <img src="<?php //echo base_url(); ?>assets/images/women_model1.png" alt=""> -->
						  <img src="<?php echo base_url(); ?>assets/images/women_model4copy.jpg" alt="">
                        </figure>
                        <div class="mad_item_desc with_bg_img">
                          <div class="mad_author style2">
                            <h3 class="mad_title_style2">Rosy</h3>
                    ...
                    <div>
                      ...
                      <a href="#" class="mad_item_hover style2">
                        ...
                        <figure>
                          <!-- <img src="<?php //echo base_url(); ?>assets/images/women_model2.png" alt=""> -->
						  <img src="<?php echo base_url(); ?>assets/images/women_model5copy.jpg" alt="">
                        </figure>
                        <div class="mad_item_desc with_bg_img">
                          <div class="mad_author style2">
                            <h3 class="mad_title_style2">Liza</h3>
                    ...
                    <div>
                      ...
                      <a href="#" class="mad_item_hover style2">
                        ...
                        <figure>
                          <!-- <img src="<?php //echo base_url(); ?>assets/images/women_model1.png" alt=""> -->
						  <img src="<?php echo base_url(); ?>assets/images/women_model7copy.jpg" alt="">
                        </figure>
                        <div class="mad_item_desc with_bg_img">
                          <div class="mad_author style2">
                            <h3 class="mad_title_style2">Rosy</h3>
                    ...
                    <div>
                      ...
                      <a href="#" class="mad_item_hover style2">
                        ...
                        <figure>
                          <!-- <img src="<?php //echo base_url(); ?>assets/images/women_model2.png" alt=""> -->
						  <img src="<?php echo base_url(); ?>assets/images/women_model8copy.jpg" alt="">
                        </figure>
                        <div class="mad_item_desc with_bg_img">
                          <div class="mad_author style2">
                            <h3 class="mad_title_style2">Liza</h3>
                    ...
                    <div>
                      ...
                      <a href="#" class="mad_item_hover style2">
                        ...
                        <figure>
                          <!-- <img src="<?php //echo base_url(); ?>assets/images/women_model3.png" alt=""> -->
						  <img src="<?php echo base_url(); ?>assets/images/women_model9copy.jpg" alt="">
                        </figure>
                        <div class="mad_item_desc with_bg_img">
                          <div class="mad_author style2">
                            <h3 class="mad_title_style2">Merry</h3>
            ...
            <div class="container">
              ...
              <div class="row">
                <div class="col-md-5">
                  ...
                  <!-- <figure><img src="<?php //echo base_url(); ?>assets/images/magazine_620x480.png" alt=""></figure> -->
				  <figure><img src="<?php echo base_url(); ?>assets/images/magazine_620x480copy.jpg" alt=""></figure>
                ...
                <div class="col-md-7">
                  ...
                  <div class="mad_section_container">
                    ...
                    <a href="<?php echo base_url('welcome/blog'); ?>" class="mad_button style2">Read All</a>
                  </div>
                  ...
                  <div class="owl-carousel style2" data-max-items="2">
                    ...
                    <div>
                      ...
                      <div class="mad_blog_post">
                        <figure>
                          <!-- <img src="<?php //echo base_url(); ?>assets/images/570x370_img1.jpg" alt=""> -->
						  <img src="<?php echo base_url(); ?>assets/images/maxresdefault1.jpg" alt="">
                          <div class="mad_post_date">

                            <div class="date">14 / JAN / 2019</div>
                        ...
                        <div class="mad_post_content clearfix">
                          <div class="mad_post_info">
                            ...
                            <h2><a href="<?php echo base_url(); ?>">Slider Blog Post Title Here</a></h2>
                    ...
                    <div>
                      ...
                      <div class="mad_blog_post">
                        <figure>
                          <!-- <img src="<?php //echo base_url(); ?>assets/images/570x370_img2.jpg" alt=""> -->
						  <img src="<?php echo base_url(); ?>assets/images/maxresdefault.jpg" alt="">
                          <div class="mad_post_date">
                    ...
                    <div>
                      ...
                      <div class="mad_blog_post">
                        <figure>
                          <!-- <img src="<?php //echo base_url(); ?>assets/images/570x370_img1.jpg" alt=""> -->
						  <img src="<?php echo base_url(); ?>assets/images/maxresdefault2.jpg" alt="">
                          <div class="mad_post_date">
      ...
      <div id="contact">
                ...
                <form id="contact_form" action="#" method="post" class="contact_form">
                  <ul>
                    <li class="row">
                      ...
                      <div class="col-sm-6">
                        <input type="text" name="cf_name" placeholder="First Name" required>
                      </div>
                      <div class="col-sm-6">
                        <input type="text" name="cf_name" placeholder="Last Name" required>
                      </div>

                    </li>
                    <li>
                      <input type="email" name="cf_email" placeholder="Emai" required>
                    </li>
                    <li>
                      <textarea name="cf_message" placeholder="Message..." required></textarea>
                    </li>
                  </ul>
                  <button name="map" class="mad_button">Make An Appointment</button>
                </form>
        ...
        <div class="relative">
		  ...
		  <!-- <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6331027.020068825!2d-84.95823215299069!3d39.212856896593074!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xbde22396ca55896!2sConnecture!5e0!3m2!1sen!2sin!4v1544772846189" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe> -->
		  
		  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d41305460.96536294!2d-130.17200189938393!3d50.81105892802433!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4b0d03d337cc6ad9%3A0x9968b72aa2438fa5!2sCanada!5e0!3m2!1sen!2sin!4v1544773169904" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
