                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="f_name" value="<?php echo $row->f_name; ?>" >
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Lastname</label>
                                    <input class="input--style-4" type="text" name="l_name" value="<?php echo $row->l_name; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                             <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="date" name="dob" id="dob" value="<?php echo $row->dob; ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="phone" name="m_no" value="<?php echo $row->m_no; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="password" name="pass" id="pass" value="<?php echo $row->pass; ?>">
                                </div>
                            </div>
                        </div>
                              <div class="row row-space">
                            ...
                            <div class="col-2">
                              ...
                              <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="password" name="c_pass" value="<?php echo set_value('pass'); ?>">
                                </div>
                            </div>
