   ...
   <!--<?php echo @$error; ?>-->
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter password">
                     ...
                     <div class="create-account">
                        <p>
                           <h4> <a href="<?php echo base_url(); ?>welcome/forgotpassword" id="register-btn" class="uppercase">Forgot Password?</a></h4>
                        </p>
                    </div>

                 
                    <div class="container-login100-form-btn">
                        <button class="login100-form-btn" name="submit"><b><a href="<?php echo base_url('welcome/index'); ?>">LOGIN</a></b>  
                        </button>
                    </div>
